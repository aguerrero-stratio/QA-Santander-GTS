Feature: HU_002_Ingesta de la tabla tp_interests_hscode en Landing

  As Data Analyst I Want to ingest data table tp_interests_hscode in the Landing area So I will transform and validate the data table
