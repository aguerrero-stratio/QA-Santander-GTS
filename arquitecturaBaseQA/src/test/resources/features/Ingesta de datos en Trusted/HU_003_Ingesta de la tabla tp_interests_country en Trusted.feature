Feature: HU_003_Ingesta de la tabla tp_interests_country en Trusted

  As Data Analyst I Want to ingest data table tp_interests_country in the Trusted area So I will transform and validate the data table
