Feature: TRUSTED_Enterprise
  ...
  Background:
    ...
    @sparta_enterprise_trusted_qrules_ok
    Scenario: Ejecución del workflow 'ot-et-tt-enterprise-company' con gobierno del dato
      ...
      Then Se aplican las siguientes reglas de calidad con resultado
        | OT.T.Enterprise_EnterpriseCompany.agent.PR.B.Completeness.MF.001                         | OK |
        | OT.T.Enterprise_EnterpriseCompany.company_global_id.PR.B.Completeness.MF.001             | OK |
        | OT.T.Enterprise_EnterpriseCompany.company_name.PR.B.Completeness.MF.001                  | OK |
        | OT.T.Enterprise_EnterpriseCompany.country_incorporation.PR.B.Completeness.MF.001         | OK |
        | OT.T.Enterprise_EnterpriseCompany.entity.PR.B.Completeness.MF.001                        | OK |
        | OT.T.Enterprise_EnterpriseCompany.identification_legal_customer.PR.B.Completeness.MF.001 | OK |
    ...
    @sparta_enterprise_trusted_qrules_ko
    Scenario: Ejecución del workflow 'ot-et-tt-enterprise-company' con gobierno del dato negativo
      ...
      When Se ejecuta el workflow con Id "69301367-8f13-4f2e-8366-eb6ed3e9586f"
      Then Se aplican las siguientes reglas de calidad con resultado
        | OT.T.Enterprise_EnterpriseCompany.agent.PR.B.Completeness.MF.001                         | KO |
        | OT.T.Enterprise_EnterpriseCompany.company_global_id.PR.B.Completeness.MF.001             | KO |
        | OT.T.Enterprise_EnterpriseCompany.company_name.PR.B.Completeness.MF.001                  | KO |
        | OT.T.Enterprise_EnterpriseCompany.country_incorporation.PR.B.Completeness.MF.001         | KO |
        | OT.T.Enterprise_EnterpriseCompany.entity.PR.B.Completeness.MF.001                        | KO |
        | OT.T.Enterprise_EnterpriseCompany.identification_legal_customer.PR.B.Completeness.MF.001 | KO |
        | OT.T.Enterprise_EnterpriseCompany.ind_cash_nexus.PR.B.Completeness.MF.001                | KO |
    ...
    Scenario: Ejecución del workflow 'ot-et-tt-enterprise-company-activity' con gobierno del dato negativo
      ...
      When Se ejecuta el workflow con Id "832d401b-1727-4d16-b443-8b9a6607cb73"
      Then Se aplican las siguientes reglas de calidad con resultado
        | OT.T.Enterprise_EnterpriseCompanyActivity.company_activity_id.PR.B.Completeness.MF.001   | KO |
        | OT.T.Enterprise_EnterpriseCompanyActivity.company_global_id.PR.B.Completeness.MF.001     | KO |
    ...
    Scenario: Ejecución del workflow 'ot-et-tt-enterprise-company-address' con gobierno del dato
      ...
      When Se ejecuta el workflow con Id "a8001fa1-e68f-41a8-bff6-4d544800b1d3"
      Then Se aplican las siguientes reglas de calidad con resultado
        | OT.T.Enterprise_EnterpriseCompanyAddress.building_name.PR.B.Completeness.MF.001                  | OK |
        | OT.T.Enterprise_EnterpriseCompanyAddress.company_address_id.PR.B.Completeness.MF.001             | OK |
        | OT.T.Enterprise_EnterpriseCompanyAddress.company_address_type_id.PR.B.Completeness.MF.001        | OK |
        | OT.T.Enterprise_EnterpriseCompanyAddress.company_global_id.PR.B.Completeness.MF.001              | OK |
        | OT.T.Enterprise_EnterpriseCompanyAddress.country.PR.B.Completeness.MF.001                        | OK |
        | OT.T.Enterprise_EnterpriseCompanyAddress.county_identification.PR.B.Completeness.MF.001          | OK |
        | OT.T.Enterprise_EnterpriseCompanyAddress.department.PR.B.Completeness.MF.001                     | OK |
        | OT.T.Enterprise_EnterpriseCompanyAddress.district_name.PR.B.Completeness.MF.001                  | OK |
        | OT.T.Enterprise_EnterpriseCompanyAddress.floor.PR.B.Completeness.MF.001                          | OK |
        | OT.T.Enterprise_EnterpriseCompanyAddress.location.PR.B.Completeness.MF.001                       | OK |
        | OT.T.Enterprise_EnterpriseCompanyAddress.post_code_identification.PR.B.Completeness.MF.001       | OK |
        | OT.T.Enterprise_EnterpriseCompanyAddress.post_office_box.PR.B.Completeness.MF.001                | OK |
        | OT.T.Enterprise_EnterpriseCompanyAddress.province.PR.B.Completeness.MF.001                       | OK |
        | OT.T.Enterprise_EnterpriseCompanyAddress.region_identification.PR.B.Completeness.MF.001          | OK |
        | OT.T.Enterprise_EnterpriseCompanyAddress.state.PR.B.Completeness.MF.001                          | OK |
        | OT.T.Enterprise_EnterpriseCompanyAddress.street_building_identification.PR.B.Completeness.MF.001 | OK |
    ...
    Scenario: Ejecución del workflow 'ot-et-tt-enterprise-company-address' con gobierno del dato negativo
     ...
     Con un juego de datos de entrada que no cumplan las Quality Rules, validar que el resultado de estas es 'KO'
      ...
      When Se ejecuta el workflow con Id "a8001fa1-e68f-41a8-bff6-4d544800b1d3"
      Then Se aplican las siguientes reglas de calidad con resultado
        | OT.T.Enterprise_EnterpriseCompanyAddress.building_name.PR.B.Completeness.MF.001                  | KO |
        | OT.T.Enterprise_EnterpriseCompanyAddress.company_address_id.PR.B.Completeness.MF.001             | KO |
        | OT.T.Enterprise_EnterpriseCompanyAddress.company_address_type_id.PR.B.Completeness.MF.001        | KO |
        | OT.T.Enterprise_EnterpriseCompanyAddress.company_global_id.PR.B.Completeness.MF.001              | KO |
        | OT.T.Enterprise_EnterpriseCompanyAddress.country.PR.B.Completeness.MF.001                        | KO |
        | OT.T.Enterprise_EnterpriseCompanyAddress.county_identification.PR.B.Completeness.MF.001          | KO |
        | OT.T.Enterprise_EnterpriseCompanyAddress.department.PR.B.Completeness.MF.001                     | KO |
        | OT.T.Enterprise_EnterpriseCompanyAddress.district_name.PR.B.Completeness.MF.001                  | KO |
        | OT.T.Enterprise_EnterpriseCompanyAddress.floor.PR.B.Completeness.MF.001                          | KO |
        | OT.T.Enterprise_EnterpriseCompanyAddress.location.PR.B.Completeness.MF.001                       | KO |
        | OT.T.Enterprise_EnterpriseCompanyAddress.post_code_identification.PR.B.Completeness.MF.001       | KO |
        | OT.T.Enterprise_EnterpriseCompanyAddress.post_office_box.PR.B.Completeness.MF.001                | KO |
        | OT.T.Enterprise_EnterpriseCompanyAddress.province.PR.B.Completeness.MF.001                       | KO |
        | OT.T.Enterprise_EnterpriseCompanyAddress.region_identification.PR.B.Completeness.MF.001          | KO |
        | OT.T.Enterprise_EnterpriseCompanyAddress.state.PR.B.Completeness.MF.001                          | KO |
        | OT.T.Enterprise_EnterpriseCompanyAddress.street_building_identification.PR.B.Completeness.MF.001 | KO |
        | OT.T.Enterprise_EnterpriseCompanyAddress.street_name.PR.B.Completeness.MF.001                    | KO |
        | OT.T.Enterprise_EnterpriseCompanyAddress.subdepartment.PR.B.Completeness.MF.001                  | KO |
    ...
    Scenario: Ejecución del workflow 'ot-et-tt-enterprise-company-address-type' con gobierno del dato negativo
      ...
      When Se ejecuta el workflow con Id "9e04dbba-02d5-4be1-bd71-42f92ff968b3"
      Then Se aplican las siguientes reglas de calidad con resultado
        | OT.T.Enterprise_EnterpriseCompanyAddressType.company_address_type_id.PR.B.Completeness.MF.001 | KO |
        | OT.T.Enterprise_EnterpriseCompanyAddressType.description.PR.B.Completeness.MF.001             | KO |
  ...
  @sparta_enterprise_trusted_qrules_ok
    ...
    Scenario: Ejecución del workflow 'ot-et-tt-enterprise-company-cmc' con gobierno del dato negativo
      ...
      When Se ejecuta el workflow con Id "2a91c6fd-9a81-45ca-ad96-fab42aec3f2d"
      Then Se aplican las siguientes reglas de calidad con resultado
        | OT.T.Enterprise_EnterpriseCompanyCmc.cmc.PR.B.Completeness.MF.001               | KO |
    ...
    Scenario: Ejecución del workflow 'ot-et-tt-enterprise-company-contact' con gobierno del dato negativo
      ...
      When Se ejecuta el workflow con Id "a4c50393-bfa3-4306-b5f6-78b3c7fcab7a"
      Then Se aplican las siguientes reglas de calidad con resultado
        | OT.T.Enterprise_EnterpriseCompanyCountry.company_global_id.PR.B.Completeness.MF.001  | KO |
    ...
    Scenario: Ejecución del workflow 'ot-et-tt-enterprise-company-identification' con gobierno del dato
      ...
      When Se ejecuta el workflow con Id "46a9ea2d-09cb-4e3d-864f-1b6df96833cf"
      Then Se aplican las siguientes reglas de calidad con resultado
        | OT.T.Enterprise_EnterpriseCompanyIdentification.company_global_id.PR.B.Completeness.MF.001         | OK |
        | OT.T.Enterprise_EnterpriseCompanyIdentification.company_identification_id.PR.B.Completeness.MF.001 | OK |
    ...
    Con un juego de datos de entrada que no cumplan las Quality Rules, validar que el resultado de estas es 'KO'
      ...
      When Se ejecuta el workflow con Id "46a9ea2d-09cb-4e3d-864f-1b6df96833cf"
      Then Se aplican las siguientes reglas de calidad con resultado
        | OT.T.Enterprise_EnterpriseCompanyIdentification.company_global_id.PR.B.Completeness.MF.001         | KO |
        | OT.T.Enterprise_EnterpriseCompanyIdentification.company_identification_id.PR.B.Completeness.MF.001 | KO |
        | OT.T.Enterprise_EnterpriseCompanyIdentification.document_number.PR.B.Completeness.MF.001           | KO |
        | OT.T.Enterprise_EnterpriseCompanyIdentification.document_type.PR.B.Completeness.MF.001             | KO |
    ...
    Scenario: Ejecución del workflow 'ot-et-tt-enterprise-company-permission' con gobierno del dato negativo
      ...
      When Se ejecuta el workflow con Id "32c31964-db70-4385-a83f-ac30aa0a206e"
      Then Se aplican las siguientes reglas de calidad con resultado
        | OT.T.Enterprise_EnterpriseCompanyPermission.description.PR.B.Completeness.MF.001    | KO |
    ...
    Scenario: Ejecución del workflow 'ot-et-tt-enterprise-company-resource' con gobierno del dato negativo
      ...
      When Se ejecuta el workflow con Id "1208d215-a4d4-4767-98a1-56b078efb3a2"
      Then Se aplican las siguientes reglas de calidad con resultado
        | OT.T.Enterprise_EnterpriseCompanyResource.cmc.PR.B.Completeness.MF.001                      | KO |
        | OT.T.Enterprise_EnterpriseCompanyResource.company_resource_id.PR.B.Completeness.MF.001      | KO |
    ...
    Scenario: Ejecución del workflow 'ot-et-tt-enterprise-company-resource-type' con gobierno del dato negativo
      ...
      When Se ejecuta el workflow con Id "09a42e90-0a80-4bc0-9f81-dcbc02eeab8b"
      Then Se aplican las siguientes reglas de calidad con resultado
        | OT.T.Enterprise_EnterpriseCompanyResourceType.company_resource_type_id.PR.B.Completeness.MF.001 | KO |
        | OT.T.Enterprise_EnterpriseCompanyResourceType.description.PR.B.Completeness.MF.001              | KO |
    ...
    añade el TS y vuelca los datos en el hdfs asociado al area de TRUSTED
      ...
      When Se ejecuta el workflow con Id "87c8a5bb-9b01-4726-b3a1-d68793304bb7"
      Then Se aplican las siguientes reglas de calidad con resultado
        | OT.T.Enterprise_EnterpriseCompanyUser.cmc.PR.B.Completeness.MF.001                     | OK |
    ...
    Con un juego de datos de entrada que no cumplan las Quality Rules, validar que el resultado de estas es 'KO'
      ...
      When Se ejecuta el workflow con Id "87c8a5bb-9b01-4726-b3a1-d68793304bb7"
      Then Se aplican las siguientes reglas de calidad con resultado
        | OT.T.Enterprise_EnterpriseCompanyUser.cmc.PR.B.Completeness.MF.001                     | KO |
        | OT.T.Enterprise_EnterpriseCompanyUser.company_user_id.PR.B.Completeness.MF.001         | KO |
        | OT.T.Enterprise_EnterpriseCompanyUser.global_id.PR.B.Completeness.MF.001               | KO |
    ...
    Scenario: Ejecución del workflow 'ot-et-tt-enterprise-company-user-permission-resource' con gobierno del dato
      ...
      When Se ejecuta el workflow con Id "c21c47c5-1c50-4559-a222-6bf79c5d7f6b"
      Then Se aplican las siguientes reglas de calidad con resultado
        | OT.T.Enterprise_EnterpriseCompanyUserPermissionResource.company_resource_id.PR.B.Completeness.MF.001                         | OK |
    ...
    Con un juego de datos de entrada que no cumplan las Quality Rules, validar que el resultado de estas es 'KO'
      ...
      When Se ejecuta el workflow con Id "c21c47c5-1c50-4559-a222-6bf79c5d7f6b"
      Then Se aplican las siguientes reglas de calidad con resultado
        | OT.T.Enterprise_EnterpriseCompanyUserPermissionResource.company_resource_id.PR.B.Completeness.MF.001                         | KO |
        | OT.T.Enterprise_EnterpriseCompanyUserPermissionResource.company_user_id.PR.B.Completeness.MF.001                             | KO |
        | OT.T.Enterprise_EnterpriseCompanyUserPermissionResource.company_user_permission_company_resource_id.PR.B.Completeness.MF.001 | KO |
    ...
    Con un juego de datos de entrada que no cumplan las Quality Rules, validar que el resultado de estas es 'KO'
      ...
      When Se ejecuta el workflow con Id "2f008976-0968-4cd5-9067-f01b7421ae31"
      Then Se aplican las siguientes reglas de calidad con resultado
        | OT.T.Enterprise_EnterpriseCountry.country_id.PR.B.Completeness.MF.001  | KO |
        | OT.T.Enterprise_EnterpriseCountry.name.PR.B.Completeness.MF.001        | KO |