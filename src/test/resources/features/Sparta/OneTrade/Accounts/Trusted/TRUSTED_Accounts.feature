Feature: TRUSTED_Accounts
  ...
  Background:
    ...
    Scenario: Ejecución del workflow 'ot-ac-tt-accounts' sin gobierno del dato
      ...
      Then Se crea en XDATA la tabla "GTS.QA_ACTUAL_ot-ac-tt-accounts" con el hdfs-output del workflow "hdfs://gts-hdfs/gts/data/trusted/onetrade/accounts_accounts"
      ...
      Then Se crea en XDATA la tabla "GTS.QA_ACTUAL_ot-ac-tt-accounts_currencies_refusals" con el hdfs-output del workflow "hdfs://gts-hdfs/gts/data/trusted/onetrade/accounts_currencies_refusals"
      ...
      Then Se crea en XDATA la tabla "GTS.QA_ACTUAL_ot-ac-tt-accounts_bics_refusals" con el hdfs-output del workflow "hdfs://gts-hdfs/gts/data/trusted/onetrade/accounts_bics_refusals"
      ...
      Then Se crea en XDATA la tabla "GTS.QA_ACTUAL_ot-ac-tt-accounts_countries_refusals" con el hdfs-output del workflow "hdfs://gts-hdfs/gts/data/trusted/onetrade/accounts_countries_refusals"
    ...
    Scenario: Ejecución del workflow 'ot-ac-tt-company-member' con gobierno del dato
      ...
      Then Se crea en XDATA la tabla "GTS.QA_ACTUAL_ot-ac-tt-company-member" con el hdfs-output del workflow "hdfs://gts-hdfs/gts/data/trusted/onetrade/accounts_company_member"
    ...
    Scenario: Ejecución del workflow 'ot-ac-tt-company-member-account' con gobierno del dato
      ...
      Then Se crea en XDATA la tabla "GTS.QA_ACTUAL_ot-ac-tt-company-member-account" con el hdfs-output del workflow "hdfs://gts-hdfs/gts/data/trusted/onetrade/accounts_company_member_account"
