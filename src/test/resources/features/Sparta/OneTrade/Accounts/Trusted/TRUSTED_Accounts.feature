Feature: TRUSTED_Accounts
  ...
  Background:
    ...
    Scenario: Ejecución del workflow 'ot-ac-tt-accounts' sin gobierno del dato
      ...
      Then Se crea en XDATA la tabla "GTS.QA_ACTUAL_ot_ac_tt_accounts" con el hdfs-output del workflow "hdfs://gts-hdfs/gts/data/trusted/onetrade/accounts/accounts_accounts"
      ...
      Then Se crea en XDATA la tabla "GTS.QA_ACTUAL_ot_ac_tt_accounts_currencies_refusals" con el hdfs-output del workflow "hdfs://gts-hdfs/gts/data/trusted/onetrade/accounts/accounts_currencies_refusals"
      ...
      Then Se crea en XDATA la tabla "GTS.QA_ACTUAL_ot_ac_tt_accounts_bics_refusals" con el hdfs-output del workflow "hdfs://gts-hdfs/gts/data/trusted/onetrade/accounts/accounts_bics_refusals"
      ...
      Then Se crea en XDATA la tabla "GTS.QA_ACTUAL_ot_ac_tt_accounts_countries_refusals" con el hdfs-output del workflow "hdfs://gts-hdfs/gts/data/trusted/onetrade/accounts/accounts_countries_refusals"
    ...
    Scenario: Ejecución del workflow 'ot-ac-tt-company-member' con gobierno del dato
      ...
      Then Se crea en XDATA la tabla "GTS.QA_ACTUAL_ot_ac_tt_company_member" con el hdfs-output del workflow "hdfs://gts-hdfs/gts/data/trusted/onetrade/accounts/accounts_company_member"
