Feature: RAW_Accounts
  ...
  Background:
    ...
    Scenario: Ejecución del workflow 'ot_ac_rw_accounts' con gobierno del dato
    ...
    @Manual
    Scenario: Ejecución del workflow 'ot_ac_rw_accounts' con gobierno del dato negativo
    ...
    Scenario: Ejecución del workflow 'ot_ac_rw_accounts' sin gobierno del dato
    El workflow recoge los datos de la tabla de Postgres 'onetradeaccounts.account', castea las columnas esperadas,
    añade el TS y vuelva los datos a la ruta de parquet 'hdfs://gts-hdfs/gts/data/raw/formatted/onetrade/accounts/accounts_accounts'
    ...
    Scenario: Ejecución del workflow 'ot_ac_rw_company_member' con gobierno del dato
    ...
    añade el TS y almacena los datos en la ruta de parquet 'hdfs://gts-hdfs/gts/data/raw/formatted/onetrade/accounts/accounts_company_member'
      ...
      Then Se crea en XDATA la tabla "GTS.QA_ACTUAL_ot_ac_rw_company_member" con el hdfs-output del workflow "hdfs://gts-hdfs/gts/data/raw/formatted/onetrade/accounts/accounts_company_member"
      And  Se comprueba que el resultado obtenido "GTS.QA_ACTUAL_ot_ac_rw_company_member" coincide con el resultado esperado en XDATA "GTS.QA_EXPECTED_ot_ac_rw_company_member"
      Then Se borra la tabla de XDATA "GTS.QA_ACTUAL_ot_ac_rw_company_member"

    @Manual
    Scenario: Ejecución del workflow 'ot_ac_rw_company_member' con gobierno del dato negativo
    Con un juego de datos de entrada que no cumplan las Quality Rules, validar que el resultado de estas es 'KO'
    ...
    Scenario: Ejecución del workflow 'ot_ac_rw_company_member-account' con gobierno del dato
    ...
    añade el TS y almacena los datos en la ruta de parquet 'hdfs://gts-hdfs/gts/data/raw/formatted/onetrade/accounts/accounts_company_member_account'
      ...
      Then Se crea en XDATA la tabla "GTS.QA_ACTUAL_ot_ac_rw_company_member_account" con el hdfs-output del workflow "hdfs://gts-hdfs/gts/data/raw/formatted/onetrade/accounts/accounts_company_member_account"
    ...
    @Manual
    Scenario: Ejecución del workflow 'ot_ac_rw_company_member-account' con gobierno del dato negativo
    Con un juego de datos de entrada que no cumplan las Quality Rules, validar que el resultado de estas es 'KO'
