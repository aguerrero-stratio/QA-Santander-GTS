Feature: RAW_Accounts
  ...
  Background:
    ...
    @sparta_accounts_raw
    Scenario: Ejecución del workflow 'ot_ac_rw_company_member' sin gobierno del dato
    ...
    @sparta_accounts_raw
    Scenario: Ejecución del workflow 'ot_ac_rw_company_member-account' sin gobierno del dato
