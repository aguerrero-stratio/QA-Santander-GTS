Feature: RAW_Accounts
  ...
  Background:
    ...
    añade el TS y vuelva los datos a la ruta de parquet 'hdfs://gts-hdfs/gts/data/raw/formatted/onetrade/accounts_accounts'
      ...
      And  Se aplican las reglas de calidad "OT.RF.Accounts_Accounts.type.PR.B.Domain.PT.001/OT.RF.Accounts_Accounts.display_number.PR.B.Completeness.PT.001/OT.RF.Accounts_Accounts.type.PR.B.Completeness.PT.001" con resultado "OK"
    ...
    Con un juego de datos de entrada que no cumplan las Quality Rules, validar que el resultado de estas es 'KO'
      ...
      When Se ejecuta el workflow con Id "06012f6d-577c-46e3-b1fb-5c6d50f09abf"
      Then Se aplican las reglas de calidad "OT.RF.Accounts_Accounts.type.PR.B.Domain.PT.001/OT.RF.Accounts_Accounts.display_number.PR.B.Completeness.PT.001/OT.RF.Accounts_Accounts.type.PR.B.Completeness.PT.001" con resultado "OK"
    ...
    añade el TS y almacena los datos en la ruta de parquet 'hdfs://gts-hdfs/gts/data/raw/formatted/onetrade/accounts_company_member'
      ...
      And  Se aplican las reglas de calidad "OT.RF.Accounts_Company_Member.company_id.PR.B.Completeness.PT.001/OT.RF.Accounts_Company_Member.company_member_id.PR.B.Completeness.PT.001/OT.RF.Accounts_Company_Member.role_id.PR.B.Completeness.PT.001" con resultado "OK"
    ...
    Con un juego de datos de entrada que no cumplan las Quality Rules, validar que el resultado de estas es 'KO'
      ...
      When Se ejecuta el workflow con Id "6f9ab168-22d4-4b5c-b73f-d531b71ae20b"
      Then Se aplican las reglas de calidad "OT.RF.Accounts_Company_Member.company_id.PR.B.Completeness.PT.001/OT.RF.Accounts_Company_Member.company_member_id.PR.B.Completeness.PT.001/OT.RF.Accounts_Company_Member.role_id.PR.B.Completeness.PT.001" con resultado "KO"
    ...
    añade el TS y almacena los datos en la ruta de parquet 'hdfs://gts-hdfs/gts/data/raw/formatted/onetrade/accounts_company_member_account'
      ...
      And  Se aplican las reglas de calidad "OT.RF.Accounts_Company_Member_Account.account_country_id.PR.B.Completeness.PT.001/OT.RF.Accounts_Company_Member_Account.company_member_account_id.PR.B.Completeness.PT.001/OT.RF.Accounts_Company_Member_Account.company_member_id.PR.B.Completeness.PT.001" con resultado "OK"
    ...
    Con un juego de datos de entrada que no cumplan las Quality Rules, validar que el resultado de estas es 'KO'
      ...
      When Se ejecuta el workflow con Id "c687c329-bcf1-441d-94be-20c68bd24e4c"
      And  Se aplican las reglas de calidad "OT.RF.Accounts_Company_Member_Account.account_country_id.PR.B.Completeness.PT.001/OT.RF.Accounts_Company_Member_Account.company_member_account_id.PR.B.Completeness.PT.001/OT.RF.Accounts_Company_Member_Account.company_member_id.PR.B.Completeness.PT.001" con resultado "KO"
