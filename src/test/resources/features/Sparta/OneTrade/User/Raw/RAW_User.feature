Feature: RAW_User
  ...
  Background:
    ...
    Scenario: Ejecución del workflow 'ot-us-rw-user-company' con gobierno del dato
      ...
      And  Se aplican las siguientes reglas de calidad con resultado
        | OK                                                                  |
        | OT.RF.User_Company.cmc.PR.B.Completeness.PT.001                     |
        | OT.RF.User_Company.company_global_id.PR.B.Completeness.PT.001       |
        | OT.RF.User_Company.company_id.PR.B.Completeness.PT.001              |
        | OT.RF.User_Company.country_name.PR.B.Completeness.PT.001            |
        | OT.RF.User_Company.global_id.PR.B.Completeness.PT.001               |
        | OT.RF.User_Company.internal_represent_user.PR.B.Completeness.PT.001 |
    ...
    Scenario: Ejecución del workflow 'ot-us-rw-user-company-country' con gobierno del dato
      ...
      añade el TS y vuelva los datos a la ruta de parquet 'hdfs://gts-hdfs/gts/data/raw/formatted/onetrade/user/user_company_country'
        ...
        And  Se aplican las siguientes reglas de calidad con resultado
          | OK                                                                    |
          | OT.RF.User_CompanyCountry.country_id.PR.B.Completeness.PT.001         |
          | OT.RF.User_CompanyCountry.company_id.PR.B.Completeness.PT.001         |
          | OT.RF.User_CompanyCountry.company_country_id.PR.B.Completeness.PT.001 |
  ...
  Scenario: Ejecución del workflow 'ot-us-rw-user-contact' con gobierno del dato
    ...
    And  Se aplican las siguientes reglas de calidad con resultado
      | OK                                                        |
      | OT.RF.User_Contact.contact_data.PR.B.Completeness.PT.001  |
      | OT.RF.User_Contact.contact_id.PR.B.Completeness.PT.001    |
      | OT.RF.User_Contact.contact_type.PR.B.Completeness.PT.001  |
      | OT.RF.User_Contact.global_id.PR.B.Completeness.PT.001     |
  ...
  Scenario: Ejecución del workflow 'ot-us-rw-user-contact' con gobierno del dato negativo
    ...
    Scenario: Ejecución del workflow 'ot-us-rw-user-country' con gobierno del dato
      ...
      And  Se aplican las siguientes reglas de calidad con resultado
        | OK                                                        |
        | OT.RF.User_Country.country_id.PR.B.Completeness.PT.001    |
        | OT.RF.User_Country.country_name.PR.B.Completeness.PT.001  |
    ...
    Scenario: Ejecución del workflow 'ot-us-rw-user-user' con gobierno del dat0
      ...
      And  Se aplican las siguientes reglas de calidad con resultado
        | OK                                                            |
        | OT.RF.User_User.document_country.PR.B.Completeness.PT.001     |
        | OT.RF.User_User.document_description.PR.B.Completeness.PT.001 |
        | OT.RF.User_User.document_id.PR.B.Completeness.PT.001          |
        | OT.RF.User_User.document_number.PR.B.Completeness.PT.001      |
        | OT.RF.User_User.first_name.PR.B.Completeness.PT.001           |
        | OT.RF.User_User.global_id.PR.B.Completeness.PT.001            |
        | OT.RF.User_User.last_name.PR.B.Completeness.PT.001            |
        | OT.RF.User_User.relationship_type.PR.B.Completeness.PT.001    |
        | OT.RF.User_User.type_disposition.PR.B.Completeness.PT.0011    |
