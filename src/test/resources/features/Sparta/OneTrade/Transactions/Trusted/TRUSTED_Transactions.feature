Feature: TRUSTED_Transactions
  ...
  Background:
    ...
    con el formato establecido, añade el TS y vuelca los datos en la ruta de TRUSTED-HDFS hdfs://gts-hdfs/gts/data/trusted/onetrade/transactions/transaction_company_account
      ...
      Then Se crea en XDATA la tabla "GTS.QA_ACTUAL_ot_tr_tt_transaction_company_account" con el hdfs-output del workflow "hdfs://gts-hdfs/gts/data/trusted/onetrade/transactions/transaction_company_account"
    ...
    cantidad que contengan el formato de moneda incorrecto, añade el TS y vuelca los datos en la ruta de TRUSTED-HDFS hdfs://gts-hdfs/gts/data/trusted/onetrade/transactions/transaction
      ...
      And  Se comprueba que el resultado obtenido "GTS.QA_ACTUAL_ot_tr_tt_transaction_transaction_amount_currency_refusals" coincide con el resultado esperado en XDATA "GTS.QA_EXPECTED_ot_tr_tt_transaction_transaction_amount_currency_refusals"
      Then Se crea en XDATA la tabla "GTS.QA_ACTUAL_ot_tr_tt_transaction_transaction_balance_amount_currency_refusals" con el hdfs-output del workflow "hdfs://gts-hdfs/gts/data/trusted/onetrade/transactions/transaction_balance_amount_currency_refusals"
      And  Se comprueba que el resultado obtenido "GTS.QA_ACTUAL_ot_tr_tt_transaction_transaction_balance_amount_currency_refusals" coincide con el resultado esperado en XDATA "GTS.QA_EXPECTED_ot_tr_tt_transaction_transaction_balance_amount_currency_refusals"
      Then Se borra la tabla de XDATA "GTS.QA_ACTUAL_ot_tr_tt_transaction"
      And  Se borra la tabla de XDATA "GTS.QA_ACTUAL_ot_tr_tt_transaction_transaction_amount_currency_refusals"
      And  Se borra la tabla de XDATA "GTS.QA_ACTUAL_ot_tr_tt_transaction_transaction_balance_amount_currency_refusals"