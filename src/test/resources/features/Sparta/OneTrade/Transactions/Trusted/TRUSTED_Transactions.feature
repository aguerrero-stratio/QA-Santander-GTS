Feature: TRUSTED_Transactions
  ...
  Background:
    ...
    con el formato establecido, añade el TS y vuelca los datos en la ruta de TRUSTED-HDFS hdfs://gts-hdfs/gts/data/trusted/onetrade/transactions/transaction_company_account

      When Se ejecuta el workflow con Id "8d89ba81-521c-4a33-b25d-c3bd1400943f"
      Then Se crea en XDATA la tabla "GTS.QA_ACTUAL_ot-tr-tt-transaction-company-account" con el hdfs-output del workflow "hdfs://gts-hdfs/gts/data/trusted/onetrade/transactions/transaction_company_account"
      ...
      Then Se crea en XDATA la tabla "GTS.QA_ACTUAL_ot-tr-tt-transaction-company-account_transaction_country_refusals" con el hdfs-output del workflow "hdfs://gts-hdfs/gts/data/trusted/onetrade/transactions/transaction_country_refusals"
      ...
      Then Se crea en XDATA la tabla "GTS.QA_ACTUAL_ot-tr-tt-transaction-company-account_bics_refusals" con el hdfs-output del workflow "hdfs://gts-hdfs/gts/data/trusted/onetrade/transactions/transaction_bic_refusals"
    ...
    cantidad que contengan el formato de moneda incorrecto, añade el TS y vuelca los datos en la ruta de TRUSTED-HDFS hdfs://gts-hdfs/gts/data/trusted/onetrade/transactions/transaction
      ...
      Then Se crea en XDATA la tabla "GTS.QA_ACTUAL_ot-tr-tt-transaction" con el hdfs-output del workflow "hdfs://gts-hdfs/gts/data/trusted/onetrade/transactions/transaction"
      ...
      Then Se crea en XDATA la tabla "GTS.QA_ACTUAL_ot-tr-tt-transaction_transaction_amount_currency_refusals" con el hdfs-output del workflow "hdfs://gts-hdfs/gts/data/trusted/onetrade/transactions/transaction_amount_currency_refusals"
      ...
      Then Se crea en XDATA la tabla "GTS.QA_ACTUAL_ot-tr-tt-transaction_transaction_balance_amount_currency_refusals" con el hdfs-output del workflow "hdfs://gts-hdfs/gts/data/trusted/onetrade/transactions/transaction_balance_amount_currency_refusals"
