Feature: RAW_Mercury
  ...
  @sparta_reporting_mercury_raw
  Scenario: Ejecución del workflow 'rp-mr-rf-product' sin gobierno del dato
  ...
  @sparta_reporting_mercury_raw_qrules_ok
  ...
  @sparta_reporting_mercury_raw_qrules_ko
