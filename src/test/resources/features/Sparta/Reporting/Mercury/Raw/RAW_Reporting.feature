Feature: RAW_Mercury
  ...
  Scenario Outline: Ejecución del workflow 'rp-mr-rf-product' con gobierno del dato
  ...
  Scenario Outline: Ejecución del workflow 'rp-mr-rf-product' con gobierno del dato negativo
  ...
  Con un juego de datos de entrada que no cumplan las Quality Rules, validamos que el resultado de estas es 'KO'
    ...
    And  Se ejecuta el workflow con Id "b3e3916d-078e-462a-9562-89b374244778"
    Then Se aplican las reglas de calidad "<qrName>"
  ...
  El workflow compara los eventos ultimo y penultimo por producto procesados informando si se produce una discrepancia entre ambas medidas de volumetria RC.R.Mercury_Product.NA.PR.F.Volume.PT.001
    ...
    Then Se ejecuta el workflow con Id "ea37cfce-67b7-415d-bc7a-745c2623bcce" seleccionando como input la tabla "GTS.QA_ACTUAL_rp-mr-rf-product" para COMEXProduct
