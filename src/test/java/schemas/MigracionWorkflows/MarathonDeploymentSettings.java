...
public class MarathonDeploymentSettings {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("gracePeriodSeconds", gracePeriodSeconds).append("intervalSeconds", intervalSeconds).append("timeoutSeconds", timeoutSeconds).append("maxConsecutiveFailures", maxConsecutiveFailures).append("forcePullImage", forcePullImage).append("privileged", privileged).append("userEnvVariables", userEnvVariables).append("userLabels", userLabels).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(privileged).append(timeoutSeconds).append(userEnvVariables).append(userLabels).append(gracePeriodSeconds).append(maxConsecutiveFailures).append(intervalSeconds).append(forcePullImage).toHashCode();
    }
